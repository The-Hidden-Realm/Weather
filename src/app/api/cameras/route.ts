...
import { listVisibleCameras, listVisibleCameraCategories } from "@/lib/cameras";
...
// Cameras in a category an admin marked private are left out for everyone
// except admins.
export async function GET() {
  ...
  const cameras = listVisibleCameras(isAdmin);
  const categories = listVisibleCameraCategories(isAdmin);
